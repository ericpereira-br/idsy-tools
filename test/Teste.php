...
$json = 
'{"loc":{"id":207700920,"location":"https://spi-qrcode.bancointer.com.br/spi/pj/v2/daba2049fa4b4de5b31aad3b3deebde5",
"criacao":"2026-03-22T13:01:08.428Z","tipoCob":"cob"},
"location":"https://spi-qrcode.bancointer.com.br/spi/pj/v2/daba2049fa4b4de5b31aad3b3deebde5",
"valor":{"original":"5.00","modalidadeAlteracao":1},"calendario":{"expiracao":3600,"criacao":"2026-03-22T13:01:08.517Z"},"txid":"TEST00000000000000000000000000004","revisao":0,"status":"ATIVA","pixCopiaECola":"00020101021226930014BR.GOV.BCB.PIX2571spi-qrcode.bancointer.com.br/spi/pj/v2/daba2049fa4b4de5b31aad3b3deebde552040000530398654045.005802BR5901*6007ITAPIRA61081397715562070503***6304C20B","pix":[],"chave":"41044508000179","solicitacaoPagador":"Registro Artistico","infoAdicionais":[{"nome":"Obra","valor":"Registro51"},{"nome":"Colecionador","valor":"ERIC PEREIRA"}]}';

$array = json_decode($json, true);

$endToEndId = Convert::arrayToValue($array, 'endToEndId');
$original = Convert::arrayToValue($array, 'original');
$valor = Convert::arrayToValue($array, 'valor');
$id = Convert::arrayToValue($array, 'id');

// $endToEndId = Convert::jsonToValue($json, 'endToEndId');
// $original = Convert::jsonToValue($json, 'original');
// $valor = Convert::jsonToValue($json, 'valor');
// $id = Convert::jsonToValue($json, 'id');

echo Convert::jsonToValue($json, 'endToEndId');